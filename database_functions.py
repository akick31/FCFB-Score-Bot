...
def get_team_information(database, team):
    ...
    win_percentage = str(int(get_team_win_percentage(database, team, division)[0]*100)) + "%"
    ...
    conference_win_percentage = str(int(get_team_conference_win_percentage(database, team, division)[0]*100)) + "%"
    ...
    division_win_percentage = str(int(get_team_division_win_percentage(database, team, division)[0]*100)) + "%"
    ...
    ooc_win_percentage = str(int(get_team_ooc_win_percentage(database, team, division)[0]*100)) + "%"
    ...
    ranked_win_percentage = str(int(get_team_ranked_win_percentage(database, team, division)[0]*100)) + "%"
    ...
    win_percentage_as_ranked =str(int(get_team_win_percentage_as_ranked(database, team, division)[0]*100)) + "%"
    ...
    bowl_win_percentage = str(int(get_team_bowl_win_percentage(database, team, division)[0]*100)) + "%"
    ...
    conference_championship_win_percentage = str(int(get_team_conference_championship_win_percentage(database, team, division)[0]*100)) + "%"
    ...
    playoff_win_percentage = str(int(get_team_playoff_win_percentage(database, team, division)[0]*100)) + "%"
