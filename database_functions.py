...
def get_team_information(database, team):
    ...
    win_percentage = get_team_win_percentage(database, team, division)
    conference_wins = get_team_conference_wins(database, team, division)
    conference_losses = get_team_conference_losses(database, team, division)
    conference_record = get_record(conference_wins, conference_losses)
    conference_win_percentage = get_team_conference_win_percentage(database, team, division)
    division_wins = get_team_division_wins(database, team, division)
    division_losses = get_team_division_losses(database, team, division)
    division_record = get_record(division_wins, division_losses)
    division_win_percentage = get_team_division_win_percentage(database, team, division)
    ooc_wins = get_team_ooc_wins(database, team, division)
    ooc_losses = get_team_ooc_losses(database, team, division)
    ooc_record = get_record(ooc_wins, ooc_losses)
    ooc_win_percentage = get_team_ooc_win_percentage(database, team, division)
    ranked_wins = get_team_ranked_wins(database, team, division)
    ranked_losses = get_team_ranked_losses(database, team, division)
    ranked_record = get_record(ranked_wins, ranked_losses)
    ranked_win_percentage = get_team_ranked_win_percentage(database, team, division)
    wins_as_ranked = get_team_wins_as_ranked(database, team, division)
    losses_as_ranked = get_team_losses_as_ranked(database, team, division)
    record_as_ranked = get_record(wins_as_ranked, losses_as_ranked)
    win_percentage_as_ranked = get_team_win_percentage_as_ranked(database, team, division)
    highest_rank = get_team_highest_rank(database, team, division)
    weeks_ranked = get_team_weeks_ranked(database, team, division)
    bowl_wins = get_team_bowl_wins(database, team, division)
    bowl_losses = get_team_bowl_losses(database, team, division)
    bowl_record = get_record(bowl_wins, bowl_losses)
    bowl_win_percentage = get_team_bowl_win_percentage(database, team, division)
    conference_championship_wins = get_team_conference_championship_wins(database, team, division)
    conference_championship_losses = get_team_conference_championship_losses(database, team, division)
    conference_championship_record = get_record(conference_championship_wins, conference_championship_losses)
    conference_championship_win_percentage = get_team_conference_championship_win_percentage(database, team, division)
    playoff_appearances = get_team_playoff_appearances(database, team, division)
    playoff_wins = get_team_playoff_wins(database, team, division)
    playoff_losses = get_team_playoff_losses(database, team, division)
    playoff_record = get_record(playoff_wins, playoff_losses)
    playoff_win_percentage = get_team_playoff_win_percentage(database, team, division)
    national_championship_wins = get_team_national_championship_wins(database, team, division)
