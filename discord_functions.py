...
async def handle_team_command(config_data, message, database):
    ...
    embed.add_field(name="Current Coach", value=information_list[0], inline=False)
    embed.add_field(name="Number of Coaches", value=information_list[1], inline=False)
    embed.add_field(name="Winningest Coach", value=information_list[2], inline=False)
    embed.add_field(name="Longest Serving Coach", value=information_list[3], inline=False)
    embed.add_field(name="All-Time Record", value=information_list[4], inline=False)
    embed.add_field(name="All-Time Winning Percentage", value=information_list[5], inline=False)
    embed.add_field(name="Conference Record", value=information_list[6], inline=False)
    embed.add_field(name="Conference Winning Percentage", value=information_list[7], inline=False)
    embed.add_field(name="Division Record", value=information_list[8], inline=False)
    embed.add_field(name="Division Winning Percentage", value=information_list[9], inline=False)
    embed.add_field(name="Out of Conference Record", value=information_list[10], inline=False)
    embed.add_field(name="Out of Conference Winning Percentage", value=information_list[11], inline=False)
    embed.add_field(name="Record vs Ranked", value=information_list[12], inline=False)
    embed.add_field(name="Winning Percentage vs Ranked", value=information_list[13], inline=False)
    embed.add_field(name="Record as Ranked", value=information_list[14], inline=False)
    embed.add_field(name="Winning Percentage as Ranked", value=information_list[15], inline=False)
    embed.add_field(name="Highest Rank", value=information_list[16], inline=False)
    embed.add_field(name="Weeks Ranks", value=information_list[17], inline=False)
    embed.add_field(name="Bowl Record", value=information_list[18], inline=False)
    embed.add_field(name="Bowl Winning Percentage", value=information_list[19], inline=False)
    embed.add_field(name="Conference Championship Record", value=information_list[20], inline=False)
    embed.add_field(name="Conference Championship Winning Percentage", value=information_list[21], inline=False)
    embed.add_field(name="Playoff Appearances", value=information_list[22], inline=False)
    embed.add_field(name="Playoff Record", value=information_list[23], inline=False)
    embed.add_field(name="Playoff Winning Percentage", value=information_list[24], inline=False)
    embed.add_field(name="National Championships", value=information_list[25], inline=False)
