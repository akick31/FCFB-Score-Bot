...
fbs_worksheet = sh.worksheet("Season 9 Rankings (All-Time)")

file_location = "FCSElo.xlsx"
fcs_excel = xlrd.open_workbook(file_location)
sheet = fcs_excel.sheet_by_name('sheet')

sh3 = gc.open_by_url('https://docs.google.com/spreadsheets/d/1HXbeE-TSWCxVgWd57Y_yEQliANVZs_srLd4VWzdg_q0/edit#gid=0')
